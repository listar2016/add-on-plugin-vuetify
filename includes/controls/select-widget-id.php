 ...
 * @since 1.0.0
 */
class Control_Select_Widget_Id extends \Elementor\Base_Data_Control {
	const selectwidgetid = 'selectwidgetid';
	/**
	...
	public function content_template() {
		...
		<div class="elementor-control-field mt-4">
			<div class="elementor-control-input-wrapper">
				<input id="new-widget-id" type="text" placeholder="Widget Title" />
			</div>			
		</div>
		<div class="elementor-control-field mt-4">
			<div class="elementor-control-input-wrapper">
			<button type="button" class="elementor-button elementor-button-default elementor-button-success" id="btn-add-widget-id">Add Widget ID</button>
			</div>
		</div>	
		<# if ( data.description ) { #>
